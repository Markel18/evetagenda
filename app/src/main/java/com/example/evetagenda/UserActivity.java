...
import com.example.evetagenda.databinding.ActivityMainBinding;
...
public class UserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_agenda, R.id.nav_customers, R.id.nav_notes,R.id.nav_recipe,R.id.nav_todolist,R.id.nav_visits,R.id.nav_about_us,R.id.nav_prescription)
