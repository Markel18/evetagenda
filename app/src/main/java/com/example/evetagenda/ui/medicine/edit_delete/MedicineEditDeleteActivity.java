    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                med.anamoniBooeidi = Integer.parseInt(beef.getText().toString());
                med.anamoniAiges = Integer.parseInt(goat.getText().toString());
                med.anamoniProbata = Integer.parseInt(sheep.getText().toString());
                med.anamoniXoiroi = Integer.parseInt(pig.getText().toString());
                med.anamoniIndornithes = Integer.parseInt(indianChicken.getText().toString());
                med.anamoniMelisses = Integer.parseInt(bee.getText().toString());
                med.anamoniKreas = Integer.parseInt(meat.getText().toString());
                med.anamoniGala =Integer.parseInt( milk.getText().toString());
                med.anamoniAuga = Integer.parseInt(egg.getText().toString());
                med.anamoniMeli = Integer.parseInt(honey.getText().toString());
                med.medDosologia = dose.getText().toString();
                med.medXronosTherapias = Integer.parseInt(recoverType.getText().toString());
