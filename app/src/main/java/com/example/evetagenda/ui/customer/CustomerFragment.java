...
import com.example.evetagenda.ui.customer.customer_home.CustomerHomeFragment;
import com.example.evetagenda.ui.customer.customer_list.CustomerListFragment;
...
public class CustomerFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        fragmentTransaction.replace(R.id.flFragment, new CustomerListFragment()).commit();
    ...
    private BottomNavigationView.OnNavigationItemSelectedListener mOnNavigationItemSelectedListener
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.home:
                    fragmentTransaction.replace(R.id.flFragment, new CustomerHomeFragment()).commit();
                    return true;
                case R.id.list:
                    fragmentTransaction.replace(R.id.flFragment, new CustomerListFragment()).commit();
                    return true;
