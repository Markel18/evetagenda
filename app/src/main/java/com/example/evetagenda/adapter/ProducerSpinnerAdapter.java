...
public class ProducerSpinnerAdapter extends ArrayAdapter<Producer> {
    ...
    public ProducerSpinnerAdapter(Context context, int textViewResourceId,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        label.setText(values.get(position).getProdFLname());
